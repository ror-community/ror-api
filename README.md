...
- Optionally, uncomment [line 41 in docker-compose.yml](https://github.com/ror-community/ror-api/blob/master/docker-compose.yml#L41) in order to pull the rorapi image from Dockerhub rather than creating it from local code  
